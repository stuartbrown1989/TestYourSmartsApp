...
public class topicSelector extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        testView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if(position == 0)
                {
                    String historyText = "This is a history Quiz";
                ...
                if(position == 1)
                {
                    ...
                    String scienceText = "This is a Science Quiz";
                ...
                if(position == 2)
                {
                    ...
                    String sportsText = "This is a Sports Quiz";
                ...
                if(position == 3)
                {
                    ...
                    String filmTvText = "This is a Film/TV Quiz";
                ...
                if(position == 4)
                {
                    ...
                    String geographyText = "This is a Geography Quiz";
                ...
                if(position == 5)
                {
                    ...
                    String musicText = "This is a Music Quiz";
    ...
    private void loadTestData()
    {
        ...
        testList.add(new TestModel("1","History", 5));
        testList.add(new TestModel("2","Science", 8));
        testList.add(new TestModel("3","Sports", 10));
        testList.add(new TestModel("4","Film/TV", 14));
        testList.add(new TestModel("5","Geography", 14));
        testList.add(new TestModel("6","Music", 14));
