...
public class leaderboardSpeedrunQuiz extends AppCompatActivity {
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()) {
                        case R.id.nav_home:
                            Intent intentHome = new Intent(leaderboardSpeedrunQuiz.this, MainActivity.class);
                            startActivity(intentHome);
                            return true;

                        case R.id.nav_leaderboard:
                            Intent intentleaderB = new Intent(leaderboardSpeedrunQuiz.this,leaderboardChoiceActivity.class);
                            startActivity(intentleaderB);
                            return true;

                        case R.id.nav_account:
                            Intent intentAccount = new Intent(leaderboardSpeedrunQuiz.this, account_page.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leaderboard_speedrun_quiz);
        ...
        userView = findViewById(R.id.speedRunleader_leaderboard_view_username);
        scoreDifficultyView = findViewById(R.id.speedRunleader_leaderboard_view_score);
        bottomNavigationView.setOnNavigationItemSelectedListener(onNavigationItemReselectedListener);

        g_firestore = FirebaseFirestore.getInstance();
        userScoreList.clear();
        userScoreList.removeAll(Collections.emptyList());
        //Calling Function that locates records
        getSRLeaderBoard();
    }
    ...
    private void getSRLeaderBoard()
    {
        Task<QuerySnapshot> easyRef =
                g_firestore.collection("Leaderboards").document("Speed Run").collection("Scores")
