...
public class musicQuizActivity extends AppCompatActivity {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                    ...
                    switch (menuItem.getItemId()) {
                        case R.id.nav_home:
                            ...
                            Intent intentHome = new Intent(musicQuizActivity.this, MainActivity.class);
                        ...
                        case R.id.nav_leaderboard:
                            g_question_list.clear();
                            g_question_list.removeAll(Collections.emptyList());
                            Intent intentLeaderboard= new Intent(musicQuizActivity.this, leaderboardChoiceActivity.class);
                            startActivity(intentLeaderboard);
                            return true;

                        case R.id.nav_account:
                            Intent intentAccount = new Intent(musicQuizActivity.this, account_page.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Topic Quiz - Music");
        bottomNavigationView = findViewById(R.id.top_nav_bar);
        main_frame = findViewById(R.id.main_frame);
        bottomNavigationView.setOnNavigationItemSelectedListener(onNavigationItemReselectedListener);
        final AlphaAnimation buttonClick = new AlphaAnimation(1F, 0.8F);
        //Initializing Variables
        timetoanswer = findViewById(R.id.music_timetoanswer);
        headerTimer = findViewById(R.id.MusictimeRemaining);
        theDifficulty = findViewById(R.id.Music_difficulty);
        ...
        textViewQuestion = findViewById(R.id.Musictext_view_question);
        textViewScore = findViewById(R.id.Musictext_view_new_score);
        textViewQuestionCount = findViewById(R.id.Musictext_view_question_count);
        textColorDefaultRb = op1.getTextColors();
        confirmNext = findViewById(R.id.Musicbutton_confirm_next);
        timer = findViewById(R.id.Musictext_view_timer);
        bottomNavigationView.setOnNavigationItemSelectedListener(onNavigationItemReselectedListener);
            ...
            public void onClick(View v) {
                ...
                if (!answered) {
                    if (op1.isChecked() || op2.isChecked() || op3.isChecked() || op4.isChecked()) {
                        ...
                        Toast.makeText(musicQuizActivity.this, "Please select answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
    ...
    private void getEasyMusicQuestions()
    {
    ...
    //Get all Medium Music questions from firestore
    private void getMediumMusicQuestions()
    {
    ...
    //Get all Hard Music questions from firestore
    private void getHardMusicQuestions()
    {
    ...
    private void getuserScores()
    {
        ...
        {
            Intent resultintent = new Intent(musicQuizActivity.this, resultPageActivity.class);
            resultintent.putExtra("SCORE", score);
            resultintent.putExtra("QUIZ", "Topic Quiz - Music");
        ...
        if(Patterns.EMAIL_ADDRESS.matcher(userEmail).matches()) {
            ...
            DocumentReference userRef = g_firestore.collection("Leaderboards").document("Topic").collection("Music").document(userEmail);
            userRef.get()
                        ...
                        public void onSuccess(DocumentSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                if (checkscore < score) {
                                    ...
                                    gkscore.put("QuizType", "Music");
                                    g_firestore.collection("Leaderboards").document("Topic").collection("Music").document(userEmail).set(gkscore);
                                    setUserStatistics();
                                    startActivity(resultintent);
                                    g_question_list.clear();
                                    questionIDs.removeAll(Collections.emptyList());
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                checkstoredTopicAverage = snapshot.getDouble("Music Average");
                                ...
                                {
                                    g_firestore.collection("Statistics").document("Easy").collection("Users").document(userEmail).update("Music Average", time);
                                }
                                ...
                                if(checkstoredTopicAverage != null)
                                {
                                    ...
                                    g_firestore.collection("Statistics").document("Easy").collection("Users").document(userEmail).update("Music Average", calcNewTopicAverage);
                                }
                            ...
                            if (!snapshot.exists()) {
                                ...
                                gkstats.put("Music Average", time);
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                if(checkstoredTopicAverage == null)
                                {
                                    g_firestore.collection("Statistics").document("Medium").collection("Users").document(userEmail).update("Music Average", time);
                                }
                                if(checkstoredTopicAverage != null)
                                {
                                    calcNewTopicAverage = (time + checkstoredTopicAverage) / 2;
                                    g_firestore.collection("Statistics").document("Medium").collection("Users").document(userEmail).update("Music Average", calcNewTopicAverage);
                                }
                                calcNewAverage = (time + checkstoredaverage) / 2;
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                        ...
                        public void onSuccess(DocumentSnapshot snapshot) {
                            ...
                            if (snapshot.exists()) {
                                ...
                                if(checkstoredTopicAverage == null)
                                {
                                    g_firestore.collection("Statistics").document("Hard").collection("Users").document(userEmail).update("Music Average", time);
                                }
                                if(checkstoredTopicAverage != null)
                                {
                                    calcNewTopicAverage = (time + checkstoredTopicAverage) / 2;
                                    g_firestore.collection("Statistics").document("Hard").collection("Users").document(userEmail).update("Music Average", calcNewTopicAverage);
                                }
                                calcNewAverage = (time + checkstoredaverage) / 2;
